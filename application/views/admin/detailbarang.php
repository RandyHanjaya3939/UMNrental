        ...
        <div class="container-fluid">
          <div style="border-bottom: 1px solid black;">
            <p style="text-align: center;"> 
              <font size="6" color="black"> Detail Barang </font>
              <font size="4" color="rgb(127,127,127)"> UMNRental </font> 
            </p>
          </div>
        </div>

        <a href="<?= base_url('index.php/admin/barangview') ?>"><button style="float:right;margin-top:30px;margin-right:50px;" class="btn btn-primary">Back</button></a>
        </br></br>
        ...
        <?php foreach($barang as $row) { ?>
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-2"></div>
              <div class="col-md-4">
                <p style="font-size: 15px;color: rgb(127,127,127);"> Harga : <?php echo $row["harga"]  ?> </p>
                <p style="font-size: 15px;color: rgb(127,127,127);"> Deskripsi : <?php  echo $row["deskripsi"] ?> </p>
                <p style="font-size: 15px;color: rgb(127,127,127);"> Stock : <?php  echo $row["stock"] ?> </p>
              </div>
              <div class="col-md-6">
                <img src="<?= base_url($row['gambar'])?>" alt="Link Poster not found !" width="150" height="200">
              </div>
            </div>
          </div>
        <?php } ?>
