        ...
        <table id="table" class="table table-striped" style="width: 100%">
            ...
            <?php foreach($orderan as $row): ?>
                <tr>
                    ...
                    <td><?= $row['status'] ?></td>
                    <td>
                    <a href="<?= base_url('index.php/admin/editOrder/'.$row['id_order']) ?>"><button class="btn"><i style="color:rgb(255,215,0);" class="bi bi-pencil-square"></i></button></a>
                    <a href="<?= base_url('index.php/admin/deleteOrder/'.$row['id_order']) ?>"><button class="btn"><i style="color:red;" class="bi bi-trash"></i></button></a>
                    </td>
                </tr>
            <?php endforeach ?>
            </tbody>
