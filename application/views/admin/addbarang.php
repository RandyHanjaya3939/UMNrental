       ...
       <div class="container-fluid">
          <div style="border-bottom: 1px solid black;">
            <p style="text-align: center;"> 
              <font size="6" color="black"> Add Barang </font>
        ...
        <div class="container" style="margin-top: 35px;">
          <?php 
                echo form_open_multipart(base_url('index.php/admin/addBarang'));
          ?>
            ...
            <div class="form-group row">
              <label for="poster" class="col-sm-2 col-form-label" style="font-size:16px; text-align: right; margin-top: 8px;"><b>Gambar : </b></label>
              <div class="col-sm-8">
